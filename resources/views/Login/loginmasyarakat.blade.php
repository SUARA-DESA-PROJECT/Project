...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('assets/img/bg-login.jpeg');
        ...
        <div class="login-card">
            <div class="card-body p-4">
                <div class="card-header text-center">
                    <h5 class="card-title">Login Masyarakat</h5>
                    <p class="card-text">Selamat Datang di Halaman Login <br>Dashboard Masyarakat</p>
                </div>
                <form>
                    <div class="mb-3">
