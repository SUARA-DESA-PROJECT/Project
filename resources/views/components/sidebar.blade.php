...
<nav id="sidebar" class="active" style="background-color: #C4D6C4;">
    ...
    <div class="p-4">
        ...
        <ul class="list-unstyled components mb-5">
            ...
            <li class="mb-2">
                <a href="{{route ('verifikasilap.index') }}" style="background-color: #468B94; color: white; border-radius: 10px; padding: 10px 15px; display: block; box-shadow: 0 2px 5px rgba(0,0,0,0.2); transition: all 0.3s ease;">
            ...
            <li class="mb-2">
                <a href="{{ route('komentarpengurus.index') }}" style="background-color: #468B94; color: white; border-radius: 10px; padding: 10px 15px; display: block; box-shadow: 0 2px 5px rgba(0,0,0,0.2); transition: all 0.3s ease;">
            ...
            <li class="mb-2">
                <a href="{{ route('pengurus.kelola-laporan.index') }}" style="background-color: #468B94; color: white; border-radius: 10px; padding: 10px 15px; display: block; box-shadow: 0 2px 5px rgba(0,0,0,0.2); transition: all 0.3s ease;">
