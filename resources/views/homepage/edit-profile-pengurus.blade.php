...
<div class="container-fluid mt-4">
    <div class="edit-header">
        ...
        <h2>Edit Profile Pengurus</h2>
    </div>
    <p class="description">Silakan ubah data profil pengurus Anda pada form di bawah ini.</p>

    <form method="POST" action="{{ route('profile-pengurus.update') }}" class="edit-profile-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-section">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="username" 
                    value="{{ $pengurus->username }}" readonly>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nomor_telepon') is-invalid @enderror" 
                    ...
                    value="{{ old('nomor_telepon', $pengurus->nomor_telepon) }}">
                @error('nomor_telepon')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
...
/* Password section with enhanced animation */
.password-section {
    margin-top: 2rem;
    transition: all 0.3s ease;
}
