...
<div class="update-container" style="background-color: #ffffff">
    <div class="update-header">
        <h2><i class="fas fa-edit"></i> Edit Laporan</h2>
        <p class="update-subtitle">Perbarui informasi laporan dengan data terbaru</p>
    </div>
    ...
    <form action="{{ route('pengurus.kelola-laporan.update', $laporan->id) }}" method="POST" id="formLaporan" class="update-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            ...
            <div class="form-card">
                ...
                <select name="tempat_kejadian" id="tempat_kejadian" class="form-control @error('tempat_kejadian') is-invalid @enderror">
            ...
            <div class="form-card">
                ...
                <select name="kategori_laporan" id="kategori_laporan" class="form-control @error('kategori_laporan') is-invalid @enderror">
