            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="filterDropdown">
                        <a class="dropdown-item" href="{{ route('pengurus.riwayat.index') }}">Semua Data</a>
                        <a class="dropdown-item" href="{{ route('pengurus.riwayat.index', ['status' => 'Diverifikasi']) }}">Diverifikasi</a>
                        <a class="dropdown-item" href="{{ route('pengurus.riwayat.index', ['status' => 'Belum Diverifikasi']) }}">Belum Diverifikasi</a>
                        <a class="dropdown-item" href="{{ route('pengurus.riwayat.index', ['jenis' => 'Laporan Positif']) }}">Laporan Positif</a>
                        <a class="dropdown-item" href="{{ route('pengurus.riwayat.index', ['jenis' => 'Laporan Negatif']) }}">Laporan Negatif</a>
                        <a class="dropdown-item" href="{{ route('pengurus.riwayat.index', ['status_penanganan' => 'Sudah Ditangani']) }}">Sudah Ditangani</a>
                        <a class="dropdown-item" href="{{ route('pengurus.riwayat.index', ['status_penanganan' => 'Belum Ditangani']) }}">Belum Ditangani</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @forelse($laporans as $laporan)
                            <tr style="border-bottom: 1px solid #eee;">
                                ...
                                <td style="padding: 12px 15px; text-align: center; display: flex; justify-content: center; align-items: center;">
                                    ...
                                    <form action="{{ route('pengurus.riwayat.destroy', $laporan->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
